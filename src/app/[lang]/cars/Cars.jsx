    ...
    return (
        <div className="bg-[#F1F4F8]">
            ...
            <div className="relative flex flex-col md:flex-row max-w-screen-lg w-full gap-5 mt-5 mx-auto">
                ...
                {/* Filter Sidebar */}
                <div
                    className={`scrollbar fixed md:sticky top-0 ${isExpanded ? 'h-[calc(100vh-2rem)] p-5' : 'h-[50px] overflow-auto pt-[15px] overflow-y-hidden'} bg-[#1C1C1C] transition-all duration-500 z-50 md:w-4/12 rounded-md overflow-y-auto 
